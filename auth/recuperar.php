<?php
session_start();
$flash = $_SESSION['flash_recuperar'] ?? null;
unset($_SESSION['flash_recuperar']);
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<head>
    ...
    <title>Sprint Max — Recuperar senha</title>
    ...
    <div class="login-conteiner">
        <div class="login-esquerda">
            ...
            <div class="login-formulario-conteiner">
                ...
                <h1 class="login-titulo">Recuperar <span class="destaque">senha</span></h1>
                <p class="login-subtitulo">Informe seu e-mail para redefinir sua senha.</p>
                ...
                <form id="recuperarForm" novalidate method="POST" action="/app/controller/recuperarSenhaController.php">
                    ...
                    <div class="grupo-formulario">
                        ...
                        <div class="entrada-conteiner">
                            ...
                            <input type="email" id="recuperarEmail" name="email" placeholder="Digite seu e-mail" autocomplete="email">
                        </div>
                    </div>
