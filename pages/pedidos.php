        ...
        <main class="conteudo-pagina">
            ...
            <?php if ($erroMigracao): ?>
                <div class="card" style="padding:40px;text-align:center">
                    ...
                    <a href="/pages/dashboard.php" class="botao-primario" style="display:inline-flex">
                                    ...
                                    <tbody>
                                        <?php foreach ($pedidos as $p): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form id="formExcluirPedido<?= (int)$p['id'] ?>" method="POST" action="/app/controller/pedidoController.php">
                                                        <input type="hidden" name="acao" value="excluir_pedido">
                                                        <input type="hidden" name="pedido_id" value="<?= (int)$p['id'] ?>">
                                                        <button type="button" class="btn-icon del" title="Excluir pedido"
                                                            onclick="abrirModalExclusao({titulo:'Excluir pedido?', mensagem:'Tem certeza que deseja excluir o', alvo:'Pedido #<?= (int)$p['id'] ?>', formId:'formExcluirPedido<?= (int)$p['id'] ?>'})">
